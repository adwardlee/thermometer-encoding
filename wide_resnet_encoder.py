...
class WideResNet_Encoder:
    def __init__(self, epochs=200, batch_size=128, load_weights=True):
        ...
        self.img_channels = 3 * encode_level
    ...
    def wide_residual_network(self, img_input, classes_num, depth, k):
        ...
        def residual_block(x, out_filters, increase_filter=False):
            ...
            conv_1 = Conv2D(out_filters, kernel_size=(3, 3), strides=first_stride, padding='same',
                            kernel_initializer=he_normal(), kernel_regularizer=regularizers.l2(self.weight_decay))(
                pre_relu)
    ...
    def train(self):
        ...
        channel0, channel1, channel2 = encoder.tempencoding(channel0), encoder.tempencoding(
            channel1), encoder.tempencoding(
            channel2)
